<script>
  ...
  import AiIcon from "../lib/icons/ai-icon.svelte";
  ...
  // console.log("prophecy index: " + prophecyIndex);
  // console.log("chosen prophecy: " + prophecy);
  ...
  let ai_usefulness_1 = "";
  let ai_usefulness_2 = "";
  let ai_reliability_1 = "";
  let ai_reliability_2 = "";
  let ai_personalization_1 = "";
  let ai_personalization_2 = "";
  ...
  $: areRequiredFieldsFilled =
    ...
    ai_reliability_1 !== "" &&
    ai_reliability_2 !== "" &&
    ai_personalization_1 !== "" &&
    ai_personalization_2 !== "";

  function updateStore() {
    quizData.update((currentData) => {
      return {
        ...currentData,
        ai_validity_1: ai_validity_1,
        ai_validity_2: ai_validity_2,
        ai_usefulness_1: ai_usefulness_1,
        ai_usefulness_2: ai_usefulness_2,
        ai_reliability_1: ai_reliability_1,
        ai_reliability_2: ai_reliability_2,
        ai_personalization_1: ai_personalization_1,
        ai_personalization_2: ai_personalization_2,
      };
    });
  }
...
{#if show}
  <div class="modal">
    <div class="modal-content" on:click|stopPropagation>
      ...
      <AiIcon isActivated="true" />
      <h4>(based on our AI model)</h4>
      <Scale />
      <p>
        Within the digital echo of your actions, AI sifts through the noise to
        forecast your next move. It transforms your clicks, likes, and digital
        whispers into a map of future investment choices. Based on our AI model
        analysis, {prophecy}
      </p>
            ...
            <td>
              <div class="options">
                <label class="option">
                  <input
                    type="radio"
                    bind:group={ai_personalization_1}
                    value={rating}
                  />
                </label>
              </div>
            ...
            <td>
              <div class="options">
                <label class="option">
                  <input
                    type="radio"
                    bind:group={ai_personalization_2}
                    value={rating}
                  />
                </label>
              </div>
