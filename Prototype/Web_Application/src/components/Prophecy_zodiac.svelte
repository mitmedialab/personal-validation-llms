<script>
  ...
  import AstrologyIcon from "../lib/icons/astrology-icon.svelte";
  ...
  let zodiac_validity_1 = "";
  let zodiac_validity_2 = "";
  let zodiac_usefulness_1 = "";
  let zodiac_usefulness_2 = "";
  let zodiac_reliability_1 = "";
  let zodiac_reliability_2 = "";
  let zodiac_personalization_1 = "";
  let zodiac_personalization_2 = "";
  ...
  $: areRequiredFieldsFilled =
    ...
    zodiac_usefulness_1 !== "" &&
    zodiac_usefulness_2 !== "" &&
    zodiac_reliability_1 !== "" &&
    zodiac_reliability_2 !== "" &&
    zodiac_personalization_1 !== "" &&
    zodiac_personalization_2 !== "";

  function updateStore() {
    quizData.update((currentData) => {
      return {
        ...currentData,
        zodiac_validity_1: zodiac_validity_1,
        zodiac_validity_2: zodiac_validity_2,
        zodiac_usefulness_1: zodiac_usefulness_1,
        zodiac_usefulness_2: zodiac_usefulness_2,
        zodiac_reliability_1: zodiac_reliability_1,
        zodiac_reliability_2: zodiac_reliability_2,
        zodiac_personalization_1: zodiac_personalization_1,
        zodiac_personalization_2: zodiac_personalization_2,
      };
    });
  }
...
{#if show}
  <div class="modal">
    <div class="modal-content" on:click|stopPropagation>
      ...
      <AstrologyIcon isActivated="true" />
      <h4>(based on your zodiac sign)</h4>
      <Scale />
      <p>
        As the Moon's celestial path brings it into close proximity with the
        stoic Saturn, this cosmic alignment sheds light on the inherent human
        struggle between emotion and reason when making financial decisions.
        Based on your astrological sign, {prophecy}
      </p>
            ...
            <td>
              <div class="options">
                <label class="option">
                  <input
                    type="radio"
                    bind:group={zodiac_personalization_1}
                    value={rating}
                  />
                </label>
              </div>
            ...
            <td>
              <div class="options">
                <label class="option">
                  <input
                    type="radio"
                    bind:group={zodiac_reliability_1}
                    value={rating}
                  />
                </label>
              </div>
            ...
            <td>
              <div class="options">
                <label class="option">
                  <input
                    type="radio"
                    bind:group={zodiac_usefulness_1}
                    value={rating}
                  />
                </label>
              </div>
            ...
            <td>
              <div class="options">
                <label class="option">
                  <input
                    type="radio"
                    bind:group={zodiac_personalization_2}
                    value={rating}
                  />
                </label>
              </div>
            ...
            <td>
              <div class="options">
                <label class="option">
                  <input
                    type="radio"
                    bind:group={zodiac_reliability_2}
                    value={rating}
                  />
                </label>
              </div>
            ...
            <td>
              <div class="options">
                <label class="option">
                  <input
                    type="radio"
                    bind:group={zodiac_usefulness_2}
                    value={rating}
                  />
                </label>
              </div>
